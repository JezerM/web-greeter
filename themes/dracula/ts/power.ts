export class Power {
  ...
  public constructor() {
    this._shutdownButton = document.querySelector("#shutdown-button");
    this._restartButton = document.querySelector("#restart-button");
    this._hibernateButton = document.querySelector("#hibernate-button");
    this._suspendButton = document.querySelector("#suspend-button");
    this._cover = document.querySelector("#cover");
    this._coverMsg = document.querySelector("#cover > #message");
    this.init();
  }

  public _show_message(text: string): void {
